...
namespace WebShopFood.Migrations
{
    ...
    [Migration("20250117142940_firstMigration")]
            ...
            modelBuilder.Entity("WebShopFood.Models.Product", b =>
                {
                    ...
                    b.Property<int>("ProdAExpDateId")
                        .HasColumnType("int");

                    b.Property<int>("ProducerAndExpirationDateId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProducerAndExpirationDateId");
            ...
            modelBuilder.Entity("WebShopFood.Models.Product", b =>
                {
                    ...
                    b.HasOne("WebShopFood.Models.ProductionAndExpirationDate", "ProducerAndExpirationDate")
                        .WithMany("Products")
                        .HasForeignKey("ProducerAndExpirationDateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ProducerAndExpirationDate");
                });
